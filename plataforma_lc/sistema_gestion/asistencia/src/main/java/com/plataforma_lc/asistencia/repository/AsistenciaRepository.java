...
public interface AsistenciaRepository extends JpaRepository<Asistencia, Long>{
    ...
    @Query("SELECT a FROM Asistencia a WHERE a.id_curso = :idCurso")
    ...
    @Query("SELECT CASE WHEN COUNT(a) > 0 THEN true ELSE false END FROM Asistencia a WHERE a.id_curso = :idCurso AND a.id_estudiante = :idEstudiante AND a.fecha = :fecha")
